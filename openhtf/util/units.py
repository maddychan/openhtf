...
KILOGRAM_PER_LITRE = UnitDescriptor('kilogram per litre', 'B35', '''kg/l or kg/L''')
...
DECITONNE = UnitDescriptor('decitonne', 'DTN', '''dt or dtn''')
...
RACK_UNIT = UnitDescriptor('rack unit', 'H80', '''U or RU''')
...
PERCENT = UnitDescriptor('percent', 'P1', '''% or pct''')
